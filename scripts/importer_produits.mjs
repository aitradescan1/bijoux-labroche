...
// Carte 280px de haut. Portrait 3000x4000 → débordement 120px. Formule Y% = (400f-140)/1.2
// f = fraction de l'image où se trouve le bijou (0=haut, 1=bas)
const IMAGE_POSITIONS = {
  ...
  // Boucles lot 015-038 — portrait (orient.=6), carte 280px, débordement 120px
  // Boîte ouverte latéralement, boucles sur le couvercle (haut du portrait)
  'LBG-26-015': 'center 17%',
  'LBG-26-016': 'center 10%',
  'LBG-26-017': 'center 17%',
  'LBG-26-018': 'center 17%',
  'LBG-26-019': 'center 17%',
  'LBG-26-020': 'center 17%',
  'LBG-26-021': 'center 20%',
  'LBG-26-022': 'center 14%',
  'LBG-26-023': 'center 1%',
  'LBG-26-024': 'center 5%',
  'LBG-26-025': 'center 1%',
  ...
  'LBG-26-035': 'center 1%',
  'LBG-26-036': 'center 1%',
  'LBG-26-037': 'center 13%',
  'LBG-26-038': 'center 1%',
  // Accessoires — identifieurs coupe à vin, portrait, charm au bas du verre
  'LBG-26-039': 'center 88%',
  'LBG-26-040': 'center 88%',
  'LBG-26-041': 'center 88%',
  'LBG-26-042': 'center 88%',
  'LBG-26-043': 'center 88%',
  'LBG-26-044': 'center 88%',
  'LBG-26-045': 'center 88%',
  'LBG-26-046': 'center 88%',
  'LBG-26-047': 'center 88%',
  'LBG-26-048': 'center 88%',
  'LBG-26-049': 'center 88%',
  'LBG-26-050': 'center 88%',
  'LBG-26-051': 'center 88%',
  'LBG-26-052': 'center 88%',
  'LBG-26-053': 'center 88%',
  'LBG-26-054': 'center 88%',
  'LBG-26-055': 'center 88%',
  // Bracelets — portrait, deux boîtes, bracelet dans la boîte ouverte (droite)
  'LBG-26-056': 'center 56%',
  'LBG-26-057': 'center 67%',
  'LBG-26-058': 'center 56%',
  'LBG-26-059': 'center 77%',
  'LBG-26-060': 'center 34%',
  'LBG-26-061': 'center 50%',
  'LBG-26-062': 'center 23%',
  'LBG-26-063': 'center 64%',
  'LBG-26-064': 'center 56%',
  // Boucles lot 065-080 — portrait, boîte sombre ouverte de face, boucles à l'intérieur
  'LBG-26-065': 'center 1%',
  'LBG-26-066': 'center 10%',
  'LBG-26-067': 'center 4%',
  'LBG-26-068': 'center 17%',
  'LBG-26-069': 'center 23%',
  'LBG-26-070': 'center 17%',
  'LBG-26-071': 'center 10%',
  'LBG-26-072': 'center 34%',
  'LBG-26-073': 'center 17%',
  'LBG-26-074': 'center 17%',
  'LBG-26-075': 'center 40%',
  'LBG-26-076': 'center 26%',
  'LBG-26-077': 'center 23%',
  'LBG-26-078': 'center 23%',
  'LBG-26-079': 'center 10%',
  'LBG-26-080': 'center 17%',
};
